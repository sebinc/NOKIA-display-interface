	...
	; Compiler options:
	;
	; -ovaisu.cof -mvaisu.map --summary=default --output=default main.p1 \
...
;	Sequence of clrf's more optimal than using clear routine
	clrf	(__Lcommon+0)		;clear byte at RAM address 0x7C
	clrf	(__Lcommon+1)		;clear byte at RAM address 0x7D
